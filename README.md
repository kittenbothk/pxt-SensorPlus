...
## 編輯此專案 ![建立狀態徽章](https://github.com/kittenbothk/pxt-sensorplus/workflows/MakeCode/badge.svg)

編輯 MakeCode 中的儲存庫。

* 開啟 [https://makecode.microbit.org/](https://makecode.microbit.org/)
* 按一下**匯入**，然後按一下**匯入 URL**
* 貼上 **https://github.com/kittenbothk/pxt-sensorplus** 並按一下匯入
...
![各個程式積木渲染後的視圖](https://github.com/kittenbothk/pxt-sensorplus/raw/master/.github/makecode/blocks.png)
